        ...
        <FadeIn>
              ...
              <div className="flex gap-4">
                {personalInfo.socials.map((social) => (
                  <a
                    ...
                    className="p-2 rounded-lg text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all"
          ...
          <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
            <p className="text-center text-sm text-neutral-500 dark:text-neutral-500">
              © {currentYear} {personalInfo.name}. Built with Next.js & crafted
              with care.
            </p>
          </div>
        </FadeIn>
